...
public class MyCallBack extends ItemTouchHelper.Callback {
    ...
    public MyCallBack(PostArticleImgAdapter adapter, List<String> images, List<String> originImages) {
        ...
        Log.e("MyCallback", images.size() + "**" + originImages.size() + "");
    }
    ...
    public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder target) {
        ...
        int mPosition = target.getLayoutPosition();
        ...
        onChangeInterface.onChange(fromPosition,toPosition);
        return true;
    }
...
//            dragListener.clearView(mToPosition);
//        }
    }
...
//                Log.e("images.size",images.size()+"*iamges*"+originImages.size());
//                mToPosition = viewHolder.getAdapterPosition();
