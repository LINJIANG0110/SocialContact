package com.qianyu.communicate.emotions.fragments;
...
import com.qianyu.communicate.emotions.adapter.EmotionGridViewAdapter;
import com.qianyu.communicate.emotions.adapter.EmotionPagerAdapter;
import com.qianyu.communicate.emotions.utils.DisplayUtils;
...
import com.qianyu.communicate.emotions.widget.EmotionIndicatorView;
...
public class EmotionComplateFragment extends Fragment {
    ...
    protected void initView(View rootView){
        ...
        //获取map的类型
        emotion_map_type=getArguments().getInt(EMOTION_MAP_TYPE);
        initEmotion();
    }
