...
import com.qianyu.communicate.emotions.widget.CenterAlignImageSpan;
...
//				ImageSpan span = new ImageSpan(context, scaleBitmap);
    ...
    public static SpannableString getEmotionContent_(int emotion_map_type, final Context context, final TextView tv, SpannableString spannableString) {
        Resources res = context.getResources();
