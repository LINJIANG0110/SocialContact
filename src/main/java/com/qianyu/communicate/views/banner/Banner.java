...
import com.qianyu.communicate.views.banner.loader.ImageLoaderInterface;
import com.qianyu.communicate.views.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    //    private int mIndicatorSelectedResId = R.drawable.lunbo;
//    private int mIndicatorUnselectedResId = R.drawable.lunbo_;
    private int mIndicatorSelectedResId = R.drawable.dot_base;
    ...
    public Banner(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorSize = dm.widthPixels / 75;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, mIndicatorSelectedResId);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, mIndicatorUnselectedResId);
    ...
    public Banner setIndicWH(int w, int h) {
        this.mIndicatorWidth = w;
        this.mIndicatorHeight = h;
        return this;
    }
    ...
    private void setTitleStyleUI() {
        if (titles.size() != imageUrls.size()) {
            throw new RuntimeException("[Banners] --> The number of titles and images is different");
        }
