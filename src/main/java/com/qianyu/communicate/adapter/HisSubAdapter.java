...
public class HisSubAdapter extends MyBaseAdapter<SubScription.SubscriptionsBean, HisSubAdapter.ViewHolder> {

    public HisSubAdapter(Activity context, List data) {
        super(context, data);
    }
    ...
    protected ViewHolder getViewHolder() {
        return new ViewHolder(mInflater.inflate(R.layout.item_his_sub, null));
    }
