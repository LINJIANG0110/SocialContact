...
public class AdeptAdapter<T> extends BaseAdapter implements OnInitSelectedPosition {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mDataList != null && mDataList.size() > 0) {
            final AdeptLabel impressLabel = (AdeptLabel) mDataList.get(position);
            textView.setText(TextUtils.isEmpty(impressLabel.getAdeptName()) ? "" : impressLabel.getAdeptName());
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    for (int i = 0; i < mDataList.size(); i++) {
                        AdeptLabel adeptLabel = (AdeptLabel) mDataList.get(i);
