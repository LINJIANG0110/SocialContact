...
public class FamilySuggestAdapter extends MyBaseAdapter<FamilyList.ContentBean, FamilySuggestAdapter.ViewHolder> {

    public FamilySuggestAdapter(Activity context, List data) {
        super(context, data);
    }
    ...
    protected ViewHolder getViewHolder() {
        return new ViewHolder(mInflater.inflate(R.layout.item_family_suggest, null));
    }
...
//        Uri uri = Uri.parse("http://b.hiphotos.baidu.com/zhidao/wh%3D450%2C600/sign=902f9e35c5cec3fd8b6baf71e3b8f809/2e2eb9389b504fc2fc5fd3fce3dde71191ef6dc2.jpg");
        ...
        params.width = PixelUtil.getScreenWidth(context) / 3 - PixelUtil.dp2px(context, 10);
