...
public class HomeFriendAdapter extends MyBaseAdapter<SubScription.SubscriptionsBean, HomeFriendAdapter.ViewHolder> {

    public HomeFriendAdapter(Activity context, List data) {
        super(context, data);
    }
    ...
    protected ViewHolder getViewHolder() {
        return new ViewHolder(mInflater.inflate(R.layout.item_home_friend_, null));
    }
...
//            }
            holder.mDeleteTv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    closeFamily(position, hostListVOListBean.getSid());
                }
            });
...
//                    } else {
                        addPersonlFamily(hostListVOListBean);
//                    }
                }
            });
        }
...
//        }, WxPay.class);
    ...
    private void addPersonlFamily(SubScription.SubscriptionsBean hostListVOListBean) {
...
//                userBean.setUserType(chatRoom.getUserType());
//                userBean.setUserstate(chatRoom.getUserstate());
...
//                    return;
//                }
//                Intent intent = new Intent(context, TextUtils.equals("2", chatRoom.getUserType()) ? ChatRoomLiveActivity.class : ChatDetailActivity.class);
