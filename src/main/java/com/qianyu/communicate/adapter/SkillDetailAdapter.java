...
public class SkillDetailAdapter extends MyBaseAdapter<SkillList, SkillDetailAdapter.ViewHolder> {


    public SkillDetailAdapter(Activity context, List data) {
        super(context, data);
    }

    @Override
    protected ViewHolder getViewHolder() {
        return new ViewHolder(mInflater.inflate(R.layout.item_skill_detail, null));
    }

    @Override
    protected void onBindViewHolder_(final ViewHolder holder, int position) {
//        LinearLayout.LayoutParams params1 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
////        params1.width= PixelUtil.getScreenWidth(context)/6-4;
//        params1.width= (PixelUtil.getScreenWidth(context)-PixelUtil.dp2px(context,10))/6;
//        params1.height=(PixelUtil.getScreenWidth(context)-PixelUtil.dp2px(context,10))/6;
//        holder.mRootViewLL.setLayoutParams(params1);
//        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
//        params.width= PixelUtil.getScreenWidth(context)/6-PixelUtil.dp2px(context,14);
//        params.height=(PixelUtil.getScreenWidth(context)-PixelUtil.dp2px(context,10))/6-holder.mSkillContent.getHeight()-PixelUtil.dp2px(context,14);
