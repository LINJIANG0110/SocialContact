...
public class MyGiftFuBowAdapter extends MyBaseAdapter<GiftList.ContentBean, MyGiftFuBowAdapter.ViewHolder> {


    public MyGiftFuBowAdapter(Activity context, List data) {
        super(context, data);
    }

    @Override
    protected ViewHolder getViewHolder() {
        return new ViewHolder(mInflater.inflate(R.layout.item_my_gift_fubow, null));
    }
...
//            ImageUtil.loadPicNet(goodSBean.getGiftUrl(), holder.imageView);
            ...
            holder.mMoneyTv.setText(goodSBean.getGiftNumber() + "");
