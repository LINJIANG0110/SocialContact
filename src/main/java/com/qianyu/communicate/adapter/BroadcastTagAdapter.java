...
public class BroadcastTagAdapter<T> extends BaseAdapter implements OnInitSelectedPosition {

    private Context mContext;
    public List<T> mDataList;
    private int count = 0;

    public BroadcastTagAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mDataList != null && mDataList.size() > 0) {
            ...
            textView.setTextColor(mContext.getResources().getColor(impressLabel.isSelected() ? R.color.text_black : R.color.white));
