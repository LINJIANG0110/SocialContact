...
public class BossDialogActivity extends BaseActivity {
...
//        setFinishOnTouchOutside(false);//点击空白处，窗体不关闭
    ...
    public void initData() {
        mCallET.setText("族长正在召唤本家族成员打BOSS，点击即可传送。");
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.mSureTv:
                ...
                Tools.enterFamily(BossDialogActivity.this, contentBean.getGroupId(), true);
                finish();
                break;
        }
    }
