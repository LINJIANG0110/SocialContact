        ...
        if (id == R.id.surface_container) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    AppLog.e("position333:ACTION_DOWN");
                    break;
                case MotionEvent.ACTION_MOVE:
                    AppLog.e("position333:ACTION_MOVE");
                    break;
                case MotionEvent.ACTION_UP:
                    AppLog.e("position333:ACTION_UP");
            ...
            AppLog.e("position333:bottom_seek_progress" + event.getAction());
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    cancelDismissControlViewTimer();
                    break;
