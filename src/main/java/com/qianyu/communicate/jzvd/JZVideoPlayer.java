...
public abstract class JZVideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public static int HORIENTAL_ORIENTATION = ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE;
...
//        JZUtils.setRequestedOrientation(context, FULLSCREEN_ORIENTATION);
        JZUtils.setRequestedOrientation(context, HORIENTAL_ORIENTATION);
...
//            }
    ...
    public static void hideSupportActionBar(Context context) {
        AppLog.e(ACTION_BAR_EXIST + "==========ACTION_BAR_EXIST===============" + JZUtils.getAppCompActivity(context));
        if (ACTION_BAR_EXIST && JZUtils.getAppCompActivity(context) != null) {
            ActionBar ab = JZUtils.getAppCompActivity(context).getSupportActionBar();
            if (ab != null) {
                ab.setShowHideAnimationEnabled(false);
...
//                JZVideoPlayer.releaseAllVideos();
    ...
    public interface OnStartVideoListener {
        void onStartVideo(boolean free);
    }

    public OnStartVideoListener onStartVideoListener;
    private MediaList mediaList;

    public void setOnStartVideoListener(OnStartVideoListener onStartVideoListener, MediaList mediaList) {
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.start) {
            if (mediaList!=null&&!TextUtils.isEmpty(mediaList.getFreeType()) && !TextUtils.equals("1", mediaList.getFreeType())) {
//                NetUtils.getInstance().checkPay(mediaList.getMediaId(), 3, new NetCallBack() {
//                    @Override
//                    public void onSuccess(String result, String msg, ResultModel model) {
//                        AppLog.e("=========result=========" + result);
//                        try {
//                            JSONObject jsonObject = new JSONObject(result);
//                            String payCheck = jsonObject.getString("result");
//                            if (TextUtils.equals(payCheck, "0")) {//0付费
//                                onStartVideoListener.onStartVideo(false);
//                            } else {//1免费
//                                onStartVideoListener.onStartVideo(true);
...
//                }, null);
            ...
            AppLog.e("========fullscreen========="+currentState);
        ...
        if (id == R.id.surface_container) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    AppLog.e("position444:ACTION_DOWN");
                ...
                case MotionEvent.ACTION_MOVE:
                    AppLog.e("position444:ACTION_MOVE");
...
//                        mDownY = y;
                ...
                case MotionEvent.ACTION_UP:
                    AppLog.e("position444:ACTION_UP");
...
//        JZUtils.setRequestedOrientation(getContext(), FULLSCREEN_ORIENTATION);
        JZUtils.setRequestedOrientation(getContext(), HORIENTAL_ORIENTATION);
