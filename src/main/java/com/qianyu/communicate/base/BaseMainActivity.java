...
/**
 * Created by JavaDog on 2019-9-4.
 */
...
public abstract class BaseMainActivity extends AutoLayoutActivity {
    ...
    public void setTitleTv(int id) {
        TextView tv = findViewById(net.neiquan.applibrary.R.id.title_tv);
        tv.setText(id);
    }
    ...
    public void setNextTv(String str) {
        TextView tv = findViewById(net.neiquan.applibrary.R.id.next_tv);
        tv.setVisibility(View.VISIBLE);
        tv.setText(str);
        View iv = findViewById(net.neiquan.applibrary.R.id.next_img);
        iv.setVisibility(View.GONE);
    }

    public TextView getNextTv() {
        return (TextView) findViewById(net.neiquan.applibrary.R.id.next_tv);
    }

    public void setBackGone() {
        View tv = findViewById(net.neiquan.applibrary.R.id.ly_back);
        tv.setVisibility(View.GONE);
    }

    public void setBackImgGone() {
        View tv = findViewById(net.neiquan.applibrary.R.id.back_img);
        tv.setVisibility(View.GONE);
    }

    public void setBackTv(String text) {
        TextView tv = findViewById(net.neiquan.applibrary.R.id.back_tv);
        tv.setText(text);
        tv.setVisibility(View.VISIBLE);
        findViewById(net.neiquan.applibrary.R.id.back_img).setVisibility(View.GONE);
    }

    public void setBackImg() {
        findViewById(net.neiquan.applibrary.R.id.back_tv).setVisibility(View.GONE);
        findViewById(net.neiquan.applibrary.R.id.back_img).setVisibility(View.VISIBLE);
    }
    ...
    public void setNextImage(int id) {
        TextView tv = findViewById(net.neiquan.applibrary.R.id.next_tv);
        tv.setVisibility(View.GONE);
        ImageView iv = findViewById(net.neiquan.applibrary.R.id.next_img);
        iv.setVisibility(View.VISIBLE);
        iv.setImageResource(id);
    }

    public void setNextSearchImage(int id) {
        ImageView iv = findViewById(net.neiquan.applibrary.R.id.searh_next_img);
        iv.setVisibility(View.VISIBLE);
        iv.setImageResource(id);
    }
        ...
        if (locationHelper != null) {
            locationHelper.setCallBack(new LocationHelper.LocationCallBack() {
                ...
                public void callBack(String addr, String streetnumber, double lat, double lng, String district, String street, String city, String province) {
                    ...
                    if (user != null) {
                        NetUtils.getInstance().quickLogin(user.getUserId(), JPushInterface.getRegistrationID(BaseMainActivity.this), city, lat + "", lng + "", new NetCallBack() {
                            @Override
...
//        tintManager.setStatusBarTintResource(R.color.title_bg);
        StatusBarCompats.setStatusBarColor(this, getResources().getColor(net.neiquan.applibrary.R.color.app_color_little), 0);
    }
...
//    }
    ...
    public void setSystemBarTint_() {
        StatusBarCompats.setStatusBarColor(this, getResources().getColor(net.neiquan.applibrary.R.color.xq_title), 0);
        //只对api19以上版本有效
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
