...
public abstract class MyBaseAdapter<T, VH extends RecyclerView.ViewHolder> extends XRecyclerView.Adapter<VH> {
    ...
    public MyBaseAdapter(Activity context, List<T> data) {
        super();
