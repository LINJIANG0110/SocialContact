package com.qianyu.chatuidemo.conference;
...
import com.qianyu.chatuidemo.widget.EaseViewGroup;
 ...
 * 多人音视频会议界面
 */
public class ConferenceActivity extends FragmentActivity implements EMConferenceListener {
    ...
    private void init() {
        ...
        surfaceLayout = findViewById(R.id.layout_surface_container);
        exitFullScreenBtn = findViewById(R.id.btn_exit_full_screen);
        inviteJoinBtn = findViewById(R.id.btn_invite_join);
        callTimeView = findViewById(R.id.text_call_time);
