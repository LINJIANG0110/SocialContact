...
public class ChatRoomDetailsActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView chatRoomIdTextView = findViewById(R.id.tv_chat_room_id_value);
		TextView chatRoomNickTextView = findViewById(R.id.tv_chat_room_nick_value);
        ...
        RelativeLayout changeChatRoomNameLayout = findViewById(R.id.rl_change_chatroom_name);
        RelativeLayout changeChatRoomDescriptionLayout = findViewById(R.id.rl_change_chatroom_detail);
		...
		EaseExpandGridView ownerAdminGridView = findViewById(R.id.owner_and_administrators);
					...
					new Thread(new Runnable() {
						...
						public void run() {
							...
							runOnUiThread(new Runnable() {
								@Override
								public void run() {
									TextView tv = findViewById(R.id.tv_chat_room_nick_value);
				...
				try {
					...
					runOnUiThread(new Runnable() {
						public void run() {
                            ...
                            TextView chatRoomTitle = findViewById(R.id.tv_chatroom_name);
							...
							Button destroyButton = ChatRoomDetailsActivity.this.findViewById(R.id.btn_destroy_chatroom);
