...
public class OfflinePushSettingsActivity extends FragmentActivity implements CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle arg0) {
        ...
        EaseTitleBar titleBar = findViewById(R.id.title_bar);
        noDisturbOn = findViewById(R.id.cb_no_disturb_on);
        noDisturbOff = findViewById(R.id.cb_no_disturb_off);
        noDisturbInNight = findViewById(R.id.cb_no_disturb_only_night);
