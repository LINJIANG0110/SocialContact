 ...
 */
public class CallOptionActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle arg0) {
        ...
        // min video kbps
        EditText editMinBitRate = findViewById(R.id.edit_min_bit_rate);
        ...
        // max video kbps
        EditText editMaxBitRate = findViewById(R.id.edit_max_bit_rate);
        ...
        // max frame rate
        EditText editMaxFrameRate = findViewById(R.id.edit_max_frame_rate);
        ...
        // fixed sample rate
        RelativeLayout rlSwitchSampleRate = findViewById(R.id.rl_switch_fix_video_resolution);
        rlSwitchSampleRate.setOnClickListener(this);
        EaseSwitchButton swFixedSampleRate = findViewById(R.id.switch_fix_video_resolution);
        ...
        // offline call push
        RelativeLayout rlSwitchOfflineCallPush = findViewById(R.id.rl_switch_offline_call_push);
        rlSwitchOfflineCallPush.setOnClickListener(this);
        EaseSwitchButton swOfflineCallPush = findViewById(R.id.switch_offline_call_push);
    ...
    void initCameraResolutionSpinner(final int cameraId, final int spinnerId) {
        ...
        try {
            ...
            final Spinner spinnerVideoResolution = findViewById(spinnerId);
            ...
            spinnerVideoResolution.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (position == 0) {
                        TextView textVideoResolution = findViewById(R.id.text_video_resolution);
                    ...
                    if (size != null) {
                        ...
                        if (cameraId == Camera.CameraInfo.CAMERA_FACING_BACK) {
                            ...
                            PreferenceManager.getInstance().setCallFrontCameraResolution("");
                            Spinner frontSpinner = findViewById(R.id.spinner_video_resolution_front);
                            ...
                            PreferenceManager.getInstance().setCallBackCameraResolution("");
                            Spinner backSpinner = findViewById(R.id.spinner_video_resolution_back);
    ...
    void initAudioSampleRateSpinner(int spinnerId) {
        ...
        adapter.setDropDownViewResource(android.R.layout.simple_list_item_single_choice);
        Spinner spinnerAudioSampleRate = findViewById(spinnerId);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.rl_switch_fix_video_resolution:
                EaseSwitchButton swFixedVideoResolution = findViewById(R.id.switch_fix_video_resolution);
