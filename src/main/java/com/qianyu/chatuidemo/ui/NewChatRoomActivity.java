...
public class NewChatRoomActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		chatRoomNameEditText = findViewById(R.id.edit_chat_room_name);
		introductionEditText = findViewById(R.id.edit_chat_room_introduction);
	}
