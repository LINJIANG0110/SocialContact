...
public class PublicChatRoomsActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		etSearch = findViewById(R.id.query);
		ibClean = findViewById(R.id.search_clear);
        ...
        footLoadingLayout = footView.findViewById(R.id.loading_layout);
        footLoadingPB = footView.findViewById(R.id.loading_bar);
        footLoadingText = footView.findViewById(R.id.loading_text);
