 ...
 * 
 */
public class DiagnoseActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView currentVersion = findViewById(R.id.tv_version);
		Button uploadLog = findViewById(R.id.button_uploadlog);
