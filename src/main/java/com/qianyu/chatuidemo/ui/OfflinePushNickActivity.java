...
public class OfflinePushNickActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		inputNickName = findViewById(R.id.et_input_nickname);
		Button saveNickName = findViewById(R.id.btn_save);
		nicknameDescription = findViewById(R.id.tv_nickname_description);
