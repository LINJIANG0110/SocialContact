...
public class NewGroupActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		introductionEditText = findViewById(R.id.edit_group_introduction);
		publibCheckBox = findViewById(R.id.cb_public);
		memberCheckbox = findViewById(R.id.cb_member_inviter);
		secondTextView = findViewById(R.id.second_desc);
