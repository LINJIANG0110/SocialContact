...
public class GroupDetailsActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		RelativeLayout clearAllHistory = findViewById(R.id.clear_all_history);
		loadingPB = findViewById(R.id.progressBar);
		exitBtn = findViewById(R.id.btn_exit_grp);
		deleteBtn = findViewById(R.id.btn_exitdel_grp);
		RelativeLayout changeGroupNameLayout = findViewById(R.id.rl_change_group_name);
		RelativeLayout changeGroupDescriptionLayout = findViewById(R.id.rl_change_group_description);
		RelativeLayout changeGroupExtension = findViewById(R.id.rl_change_group_extension);
		RelativeLayout idLayout = findViewById(R.id.rl_group_id);
		idLayout.setVisibility(View.VISIBLE);
		TextView idText = findViewById(R.id.tv_group_id_value);

		RelativeLayout rl_switch_block_groupmsg = findViewById(R.id.rl_switch_block_groupmsg);
		switchButton = findViewById(R.id.switch_btn);
		RelativeLayout searchLayout = findViewById(R.id.rl_search);

		RelativeLayout blockOfflineLayout = findViewById(R.id.rl_switch_block_offline_message);
		offlinePushSwitch = findViewById(R.id.switch_block_offline_message);

		RelativeLayout announcementLayout = findViewById(R.id.layout_group_announcement);
		announcementText = findViewById(R.id.tv_group_announcement_value);

		RelativeLayout sharedFilesLayout = findViewById(R.id.layout_share_files);
		...
		EaseExpandGridView ownerAdminGridview = findViewById(R.id.owner_and_administrators_grid_view);
...
//		final ArrayList list = (ArrayList) Arrays.asList(groupId);
	...
	private class OwnerAdminAdapter extends ArrayAdapter<String> {
		...
		public View getView(final int position, View convertView, final ViewGroup parent) {
			...
			LinearLayout id_background = convertView.findViewById(R.id.l_bg_id);
